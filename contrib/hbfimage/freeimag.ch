...
// Little Endian (Intel): BGR(A) order
...
/* Color quantization algorithms. Constants used in fi_ColorQuantize(). */
// FREE_IMAGE_QUANTIZE
...
/* Dithering algorithms. Constants used in fi_Dither(). */
// FREE_IMAGE_DITHER
...
/* Lossless JPEG transformations. Constants used in fi_JPEGTransform() */
...
/* Tone mapping operators. Constants used in fi_ToneMapping() */
// FREE_IMAGE_TMO
...
/* Upsampling / downsampling filters. Constants used in fi_Rescale() */
// FREE_IMAGE_FILTER
...
#define JPEG_CMYK            0x1000  // load separated CMYK "as is" (use hb_bitOr() to combine with other flags)
...
#define TIFF_CMYK            0x0001  // reads/stores tags for separated CMYK (use hb_bitOr() to combine with compression flags)
