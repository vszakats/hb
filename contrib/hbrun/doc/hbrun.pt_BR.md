...
Arquivos:  
 ...
 - **hbstart\.hb** arquivo de inicialização de script para shell interativo Harbour\. Se presente ele é executado automaticamente na inicialização do shell\. Localizações possíveis \(em ordem de precedência\) \[\*\]: \./, $HOME/\.harbour, /etc/harbour, &lt;hbrun diretório&gt;/\.\./etc/harbour, &lt;hbrun diretório&gt;/\.\./etc, &lt;hbrun diretório&gt;
