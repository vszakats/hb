...
Files:  
 ...
 - **hbstart\.hb** startup Harbour script for interactive Harbour shell\. It gets executed automatically on shell startup, if present\. Possible locations \(in order of precedence\) \[\*\]: \./, $HOME/\.harbour, /etc/harbour, &lt;Répertoire hbrun&gt;/\.\./etc/harbour, &lt;Répertoire hbrun&gt;/\.\./etc, &lt;Répertoire hbrun&gt;
