...
FUNCTION ft_DskSize( cDrive )
   RETURN hb_vfDirSpace( hb_defaultValue( cDrive, "" ) + hb_osDriveSeparator(), HB_DISK_TOTAL )

FUNCTION ft_DskFree( cDrive )
   RETURN hb_vfDirSpace( hb_defaultValue( cDrive, "" ) + hb_osDriveSeparator(), HB_DISK_FREE )
