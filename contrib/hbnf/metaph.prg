...
FUNCTION ft_Metaph( cName, nSize )  // Calculates the metaphone of a character string
   ...
   MetaTran( " KN"  , " N"  )  // Prefixes which need special consideration
   MetaTran( " GN"  , " N"  )
   MetaTran( " PN"  , " N"  )
   MetaTran( " AE"  , " E"  )
   MetaTran( " X"   , " S"  )
   ...
   MetaTran( "MB ", "M " )  // Suffixes which need special consideration
   MetaTran( "NG ", "N " )
   ...
   MetaTran( "BB", "B"  )  // Double consonants sound much the same as singles
   MetaTran( "CC", "CH" )
   MetaTran( "DD", "T"  )
   MetaTran( "FF", "F"  )
   MetaTran( "GG", "K"  )
   ...
   MetaTran( "X", "KS" )  // X sounds (KS)

   MetaTran( "ISCH", "IX" )  // special consideration for SCH
   MetaTran( "SCH" , "SK" )

   MetaTran( "CIA", "X" )  // sh sounds (X)
   MetaTran( "SIO", "X" )
   MetaTran( "SIA", "X" )
   MetaTran( "SH" , "X" )
   MetaTran( "TIA", "X" )
   ...
   MetaTran( "SCI", "S" )  // hissing sounds (S)
   MetaTran( "SCE", "S" )
   MetaTran( "SCY", "S" )
   MetaTran( "CI" , "S" )
   MetaTran( "CE" , "S" )
   ...
   MetaTran( "GHv" , "G" )  // More G sounds, looking at surrounding vowels
   MetaTran( "vGHT", "T" )
   MetaTran( "vGH" , "W" )
   MetaTran( "GN"  , "N" )
   MetaTran( "G"   , "K" )

   MetaTran( "vHv", "H" )  // H sounds, looking at surrounding vowels
   MetaTran( "vH" , ""  )

   MetaTran( "PH", "F" )  // F sounds
   MetaTran( "V" , "F" )

   MetaTran( "D" , "T" )  // D sounds a bit like T

   MetaTran( "CK", "K" )  // K sounds
   MetaTran( "Q" , "K" )
   MetaTran( "C" , "K" )
